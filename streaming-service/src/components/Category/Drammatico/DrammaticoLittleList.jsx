...
const DrammaticoLittleList = () => {

    const handleScrollRight = () => {
        useEffect(() => {
            const $slider = document.querySelector(".slider4")
            const $afterArrow = document.querySelector(".after-arrow4")
    ...
    const handleScrollLeft = () => {
        useEffect(() => {
            const $slider = document.querySelector(".slider4")
            const $beforeArrow = document.querySelector(".before-arrow4")
    ...
    return(
        <>
            <div className="w-full text-white">
                ...
                <div className="before-arrow4 absolute bg-trasparent w-[50px] h-full flex justify-center items-center z-50" onClick={handleScrollLeft()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                        </svg>
                    </div>

                    <div className="slider4 flex gap-4 mt-2 overflow-auto overflow-x-hidden h-[225px]">
                    ...
                    <div className="w-[350px] h-[100%] rounded-lg relative bg-[url('https://pad.mymovies.it/filmclub/2017/10/059/coverlg_home.jpg')] bg-cover flex align-center justify-center">
                        ...
                        <Link to={"/drammatico"} onClick={topFunction} className="w-[100px] rounded-lg mr-8 flex items-center bg-[RGB(255,187,56)]  justify-center text-black hover:text-white transition duration-200 ease-in">    
                    ...
                    <div className="after-arrow4 absolute end-0 bg-trasparent w-[50px] h-full z-10 flex justify-center items-center" onClick={handleScrollRight()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
export default DrammaticoLittleList